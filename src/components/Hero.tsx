...
export default function Hero() {
  return (
    <section
      id="home"
      className="pt-48 pb-20 md:pt-64 md:pb-32 flex flex-col items-center text-center"
    >
      <motion.div
      ...
      >
        Building Fast, Scalable Web Apps <br className="hidden md:block" />
      ...
      >
        I'm G. Inthiyaz Hussain, a passionate Full-Stack Developer specializing
        in building exceptional digital experiences that combine stunning design
        with robust engineering. I build responsive websites, real-time apps,
        and clean user experiences that solve real business problems.
      </motion.p>
